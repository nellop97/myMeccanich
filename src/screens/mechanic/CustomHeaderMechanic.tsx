import { Bell, Calendar, Car, FileText, Menu, PlusCircle, Settings, Wrench, X } from 'lucide-react-native';
...
// Header personalizzato per meccanici con sidebar integrata
const { width: screenWidth } = Dimensions.get('window');
const SIDEBAR_WIDTH = 280;

const CustomHeaderMechanic = ({ navigation }) => {
  ...
  const handleNavigation = (screen, params = {}) => {
    ...
    switch (screen) {
      case 'appointments':
        ...
        break;
      case 'invoices':
        // Navigazione per fatturazione (da implementare)
        console.log('Navigazione a Fatturazione');
        break;
      case 'archive':
        // Navigazione per archivio auto (da implementare)
        console.log('Navigazione ad Archivio Auto');
        break;
      case 'settings':
        // Navigazione per impostazioni (da implementare)
...
export default CustomHeaderMechanic;