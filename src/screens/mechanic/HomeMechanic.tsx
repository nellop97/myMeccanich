import { Bell, Calendar, Car, DollarSign, FileText, Menu, PlusCircle, Search, Settings, Wrench, X } from 'lucide-react-native';
...
// Ottimizzata per dispositivi mobili con sidebar a scomparsa
...
const MechanicDashboardMobile = () => {
  ...
  // Stato UI locale per la navigazione tra tab e sidebar
